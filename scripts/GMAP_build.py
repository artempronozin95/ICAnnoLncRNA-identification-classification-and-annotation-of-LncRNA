...
def build(reference, kmer):
    ...
    gmap_build_logger_out_path = os.path.join('./data/output/', gmap_build + '.out.log')
    gmap_build_logger_err_path = os.path.join('./data/output/', gmap_build + '.err.log')
...
statistic = open('./data/output/statistic.csv', 'w', encoding='utf-8')
